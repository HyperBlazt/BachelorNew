...
\newline
Since most discussions of the exact string matching problem begin with the naïve method. This paper adopt this tradition, as it form a basic insight to the more complex exact string matching algorithms presented later on \cite{gusfield}.
\begin{figure}[H]
    \centering
...
\subsection{SA-IS - Correctness \& Completeness}
5-8 sider
\subsection{SA-IS - Linear Time Preprocessing}
2 sider
\subsection{Reducing suffix array size for fixed length SA-IS construction}
...
\subsection{Compressed Suffix Arrays - Burrows-Wheeler Transform}
\subsection{Block-Size Compression}
